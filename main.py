    """
    Paraphrase Engine Jaywn2u
    =========================
    Open-source NLP tool built to score text data with state-of-the-art techniques.
    ...
    APP_NAME    = "Paraphrase Engine Jaywn2u"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source NLP tool built to score text data with state-of-the-art techniques.")
